...
"for example: alertnotify=echo %%s | mail -s \"FlappyCoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. FlappyCoin is shutting down."),
